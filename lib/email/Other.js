...
module.exports = {
	...
	/* Batch Rent */
	Rent_Mer_Tricity: [  e.work ],	
	Rent_Mer_Cammebys: [  e.work ],
	Rent_Mer_JerseyCentral: [  e.work ],	
	Rent_Mer_AlmaRealtyCorpResidential: [  e.work ],
	Rent_Mer_DePaulMgmt: [  e.work ],
	Rent_Mer_FDCMgmt: [  e.work ],
	Rent_Mer_KettlerMgmt: [  e.work ],
	Rent_Mer_LyonMgmtGroup: [  e.work ],
	Rent_Mer_OlentangyVillage: [  e.work ],
	Rent_Mer_Queens: [  e.work ],
	Rent_Mer_TwoTreesCommercial: [  e.work ],
	Rent_Mer_TwoTreesMgmt: [  e.work ],
	Rent_Mer_UniversityCity: [  e.work ],	
	...
	/* Marketing */
	HA_Promotion_Monthly_ParentLevel: [ e.data, 'ksato@yapstone.com' ],
	HA_Promotion_Monthly_ChildLevel: [ e.data, 'ksato@yapstone.com' ]
