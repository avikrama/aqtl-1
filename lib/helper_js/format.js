...
var isExcludeColumn = function(item){
	re = /^((AccountId)|(merchant_id)|(Commission)|(MMFCommission)|(MMFCommission_Rate)|(Quarter)|(Bill_Rate)|(Revenue_Share)|(ACH_Cost)|(Commission_Rate)|(ParentAccountId)|(PropertyOwnerAccountId)|(StreetAddress)|(Zip)|(PropertyId)|(ChildAccountId)|(ChildName)|(ParentName)|(TxnRefIds)|(Frequency_Type)|(HomeawayPropertyId)|(ListingAccountId)|(ProcessorMid)|(CustomerName)|(Commissions_Rate)|(Total_Commissions))$/;
...
/* Table Functions */
var generateTableJSON = function(data, cb){
	var table = [];
...
var generateTable = function(data, cb) {
