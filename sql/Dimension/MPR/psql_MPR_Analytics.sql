...
create temp table COGS_Financials_Base as (
	...
	select '2016-02-29'::DATE Date , 10059903 Total_COGS , 4741161 Homeaway , (select Allocable_Card_Volume from Allocable_Card_Volume where Date in ('2016-02-29') ) Allocable_Card_Volume 
);
